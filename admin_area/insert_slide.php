    ...
    <div class="col-lg-12">
        <ol class="breadcrumb">
            <li>
                ...
                <i class="fa fa-dashboard"></i> Điều khiển / Thêm Slide
...
<?php  
    ...
    if(isset($_POST['submit'])){
        ...
        if($count<4){
            ...
            echo "<script>alert('Hình ảnh slide mới của bạn đã được chèn')</script>";
            
            echo "<script>window.open('index.php?view_slides','_self')</script>";
            
        }else{
            
           echo "<script>alert('Bạn đã chèn 4 slide rồi')</script>"; 
