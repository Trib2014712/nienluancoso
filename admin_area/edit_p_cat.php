...
<?php 
    ...
    if(isset($_GET['edit_p_cat'])){
        ...
        $edit_p_cat_id = $_GET['edit_p_cat'];// nếu tồn tại cái edit_p_cat
    ...
    <div class="col-lg-12">
        <ol class="breadcrumb">
            <li>
                ...
                <i class="fa fa-dashboard"></i> Điều khiển / Chỉnh sửa danh mục sản phẩm
            </li>
        </ol>
    </div>
</div>
...
<?php  
          ...
          if(isset($_POST['update'])){
              ...
              if($run_p_cat){
                  ...
                  echo "<script>alert('Danh mục sản phẩm của bạn đã được cập nhật')</script>";
