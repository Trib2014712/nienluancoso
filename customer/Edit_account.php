...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <label> Đất nước của khách hàng: </label>
    ...
    <div class="form-group">
        ...
        <label> Thành phố khách hàng: </label>
    ...
    <div class="text-center">
        ...
        <button name="update" class="btn btn-primary"  style=" background:linear-gradient(90deg, #5170ff, #ff66c4);">
